...
import (
	...
	tgbotapi "github.com/padchin/telegram-bot-api"
)
...
func TestSendWithMediaGroup(t *testing.T) {
	...
	cfg := tgbotapi.NewMediaGroup(ChatID, []interface{}{
		tgbotapi.NewInputMediaPhoto("https://github.com/padchin/telegram-bot-api/raw/0a3a1c8716c4cd8d26a262af9f12dcbab7f3f28c/tests/image.jpg"),
		tgbotapi.NewInputMediaVideo("https://github.com/padchin/telegram-bot-api/raw/0a3a1c8716c4cd8d26a262af9f12dcbab7f3f28c/tests/video.mp4"),
	})
	_, err := bot.Send(cfg)
	if err != nil {
		t.Error(err)
